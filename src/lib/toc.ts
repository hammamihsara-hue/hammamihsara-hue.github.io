...
export const TOC: TocEntry[] = [
  { href: '/works/on-breathing-underwater', label: 'on breathing underwater', note: 'in progress', folio: 2 },
  { href: '/works/chasing-the-sun', label: 'chasing the sun — enamorado con el sol', folio: 3 },
